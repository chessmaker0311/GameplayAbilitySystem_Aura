...
public:
	...
	void BindAbilityAction(const UAuraInputConfig* InputConfig, UserClass* Object, PressedFuncType PressedFuc, ReleasedFuncType ReleasedFunc, HeldFuncType HeldFunc);
};
